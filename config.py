...
geojson = '/data_input/geojson/Lampung_extent_1.geojson' # make a new function to list geojson file
platformname = 'Sentinel-1'
producttype='GRD'
orbitdirection='Descending'
sentineldirpath = "//sentineldata//" # Directory to save downloaded sentinel File
name_of_area = 'Java_Lampung'
########################################################################################################
...
# --------- Directory Output of Praprocesses, subset, and stack (with GPT- *.xml or Snappy) ----------- #
#########################################################################################################
# Output for Phase Praprocess
...
xmlpraprocessresultstack = subset_stack_result
########################################################################################################
...
start_date = '20190401'
end_date='20191031'
select_date = ['01Apr2018','31Oct2018']
days_of_intrvl = 12
